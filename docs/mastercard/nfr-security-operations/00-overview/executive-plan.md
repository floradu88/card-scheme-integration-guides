...
Build a secure, resilient, explainable, auditable, and production-ready Mastercard payment and interchange capability that can operate through sandbox, certification, production, reconciliation, and controlled change.

## Workstreams

1. Mastercard onboarding and acquiring sponsorship.
...
- Confirm Mastercard product and API scope.
...
### Phase 2 — Sandbox
- Create Mastercard Developers project.
...
- Complete Mastercard/acquirer scenarios.
