...
Support overlapping old/new certificates for zero-downtime rotation where Mastercard permits.

## Encryption

- TLS 1.2 or higher according to current Mastercard requirements.
- mutual TLS for Mastercard connectivity.
- encryption at rest.
- encrypted backups.
