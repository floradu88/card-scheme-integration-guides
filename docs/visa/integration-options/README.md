...
Choose one option folder below. Standalone A–F ZIP archives under [`../../../archives/`](../../../archives/) are identical copies kept for provenance.
...
| **C** — Full payment processing | [`C-full-payment-processing/`](C-full-payment-processing/) | Production-grade Visa acceptance |
