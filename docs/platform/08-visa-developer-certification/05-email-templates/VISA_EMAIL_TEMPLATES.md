# Visa / Acquirer Communication Templates

Use the assigned Visa representative or Implementation Manager once one exists. Visa Developer's published general support address is `developer@visa.com`.
...
**Subject:** VisaNet Connect – Acceptance — implementation and onboarding request — [Project/Organization]

Hello Visa Developer team,

We are preparing an implementation of VisaNet Connect – Acceptance for [generic use-case description].
...
Hello [Implementation Manager / Visa Developer team],
...
Please confirm remaining Visa actions and final production activation steps.
...
Hello [Implementation Manager / Visa Developer Support],
...
Please confirm any Visa-side actions, sequencing constraints, and validation steps required.
...
**Subject:** [SEV] Visa API production issue — [Project] — [UTC timestamp]
