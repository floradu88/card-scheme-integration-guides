...
Certification and Production require different CSR files when Two-Way SSL is used. MLE may require a separate CSR.
...
- configure `https://cert.api.visa.com/<URI>`
...
- configure `https://api.visa.com/<URI>`
...
## VisaNet Connect – Acceptance specific
Sandbox testing and certification are required before production activation. Complete API-suite access requires acquirer + Visa pre-approval. Visa states an Implementation Manager provides a project plan and onboarding forms after the applicable agreement process.
