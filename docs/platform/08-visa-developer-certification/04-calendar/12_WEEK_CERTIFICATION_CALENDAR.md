...
> Planning baseline only. Visa states onboarding can range from roughly two weeks to multiple months. Rebaseline with the assigned Implementation Manager.

| Week | Engineering | Visa / External | Evidence / Gate |
|---|---|---|---|
| W1 | Confirm API/use case, architecture, owners | Request restricted access; contact Visa/acquirer | Scope + dependency register |
...
- Thursday: external dependency/Visa/acquirer checkpoint
